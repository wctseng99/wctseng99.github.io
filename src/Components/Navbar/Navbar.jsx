...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className="lg:hidden z-10 flex items-center py-2">
        <button onClick={handleMenuToggle} className="text-xl">
          <IoMenuOutline className="text-4xl text-blue-700"></IoMenuOutline>
        </button>
        <div
          className={`fixed inset-y-0 inset-x-0 z-10 bg-white flex flex-col h-dvh transform transition-transform duration-300 ease-in-out ${
            isSideMenuOpen ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          <div className="flex items-center justify-between w-full border-b border-slate-300 bg-white py-4">
            <p className="text-2xl font-medium text-center flex-grow py-4 text-slate-700"></p>
            <button onClick={handleMenuToggle} className="text-5xl px-2">
              <IoClose className="text-3xl"></IoClose>
            </button>
          </div>
          <ul className="flex-grow flex flex-col bg-white items-start py-10 px-5">
            <li className="mb-4">
              <a
          ...
          <div className="text-xs py-4 border-t bg-white border-slate-300 flex items-center justify-center">
            <a
