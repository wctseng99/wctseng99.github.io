...
const ThemeSwitcher = () => {
  ...
  return (
    <button
      ...
      className={`flex items-center w-14 h-8 md:w-20 md:h-10 lg:w-24 lg:h-10 rounded-full transition-all duration-300 ${
    ...
    >
      <div
        className={`rounded-full py-2 px-2 ${darkMode ? "ml-auto" : "mr-auto"}`}
      >
        {darkMode ? (
