  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <a className="font-mono mt-1 z-10 font-medium leading-tight tracking-tighter text-zinc-500 hover:text-zinc-950" href="mailto: wctseng99@gmail.com">
          wctseng99@gmail.com
        </a>
        ...
        <div className="absolute z-10 lg:left-5 top-10 lg:top-1/2 lg:-translate-y-1/2">
          <ul className="flex items-center lg:items-start justify-center lg:justify-end lg:flex-col">
            <li className="mr-5 text-2xl lg:mb-6 lg:ml-10">
              <a
                className="text-zinc-500 hover:text-zinc-950 flex flex-row items-center group hover:cursor-pointer"
                onClick={onTitleClick}
              >
                <div className="hidden lg:flex border border-t-0 group-hover:border-t border-zinc-400 group-hover:border-zinc-600 w-8 group-hover:w-16 transition-all"></div>
            ...
            <li className="mr-5 text-2xl lg:mb-6 lg:ml-10">
              <a
                className="text-zinc-500 hover:text-zinc-950 flex flex-row items-center group"
