  ...
  return (
    <div className="mb-16 text-slate-700 dark:text-slate-400">
      <div className="sticky lg:relative top-0 z-10 mb-4 backdrop-blur">
        <h2 className="py-4 text-sm font-bold uppercase tracking-widest text-slate-800 dark:text-slate-300 ">
          Project
        </h2>
      </div>
        ...
        <h3 className="font-medium mb-2 leading-snug text-slate-800 dark:text-slate-200 hover:text-blue-700 dark:hover:text-sky-300 group">
          <div>
            <a
              ...
              href="https://wctseng99.github.io"
              target="_blank"
              rel="noopener"
            >
      ...
      <div className="mb-12">
        ...
        <p className="mb-4">
          ...
          Additionally, users can easily share their preferred spots by
          double-clicking the map, fostering seamless exploration and
          collaboration.
        </p>
        <ul className="mt-2 flex flex-wrap">
          <li className="mr-4">
      ...
      <div className="mb-12">
        ...
        <p className="mb-4">
          ...
          buttons in a specific sequence. The player's objective is to replicate
          the sequence by pressing the buttons in the same order.
        </p>
        <ul className="mt-2 flex flex-wrap">
          <li className="mr-4">
            <a
