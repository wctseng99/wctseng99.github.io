  ...
  return (
    <>
      <div className="flex flex-col items-center content-center justify-center h-screen z-10">
        {/* Conditionally render title based on side menu state */}
        {!isSideMenuOpen && (
          <>
        ...
        <div className="lg:hidden z-10">
          ...
          <div
            className={`fixed inset-y-0 inset-x-0 bg-transparent flex flex-col h-dvh transform transition-transform duration-300 ease-in-out ${
              isSideMenuOpen ? "translate-x-0" : "-translate-x-full"
            }`}
          >
            <div className="flex items-center justify-between w-full border-b border-slate-300 bg-white">
