    ...
    <div className="mb-32 text-slate-700 dark:text-slate-400">
      ...
      <div>
        <p className="mb-4 leading-loose">
          ...
          at{" "}
          <span className="font-semibold dark:text-slate-200 text-blue-700 z-10 transition-all duration-300 ease-in-out">
            <a
              href="https://www.ntu.edu.tw/"
              target="_blank"
              rel="noopener"
              className="bg-left-bottom bg-gradient-to-r from-blue-700 to-blue-700 dark:from-slate-200 dark:to-slate-200 bg-[length:0%_1.3px] bg-no-repeat hover:bg-[length:100%_1.3px] transition-all duration-300 ease-out"
            >
        ...
        <p className="mb-4 leading-loose">
          ...
          <span className="font-semibold dark:text-slate-200 text-blue-700 transition-all duration-300 ease-in-out">
            <a
