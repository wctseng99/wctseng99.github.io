      ...
      <div className="mb-12 lg:hover:bg-gray-200/60 dark:lg:hover:bg-gray-800/50 lg:-ml-4 lg:px-4 lg:py-4 lg:rounded-lg group">
        <a href="http://www.eng.ntu.edu.tw/" target="_blank" rel="noopener">
          ...
          <p className="mb-4 leading-loose">
            ...
            Energy Systems Engineering and Economics course (CIE5143/
            ChemE5071). This role sharpened my leadership and communication
            skills. Teaching diverse subjects, including machine learning
            applications in renewable energy, data science in the energy
            industry, and energy economics, enabled me to adeptly convey
            intricate concepts and cultivate a collaborative learning
            environment.
          </p>
          <ul className="mt-2 flex flex-wrap">
            <li className="mr-2 mt-2">
